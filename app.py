...
let state = {
  ...
  categoryOpen:{},subdivisionOpen:{},editingUser:null,userEditor:null,permissionDb:"TOA",self_admin:false,self_default_db:"",self_allowed_dbs:[],personal_workspace:{},can_personal_admin:false,selectedFileScope:"shared",
